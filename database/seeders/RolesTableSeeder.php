    ...
    public function run(): void
    {
        ...
        DB::table('roles')->insert([
            ...
            5 => [
                ...
                'guard_name' => 'web',
                'name' => 'provider',
                'description' => 'The credentialed/verified second-party role (e.g. specialist, professional, advisor). Forks rename or extend in the seeder.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            6 => [
                ...
                'guard_name' => 'web',
                'name' => 'consumer',
                'description' => 'The consumer / end-user role (e.g. client, patient, customer). Alias for "registered" with explicit two-sided naming.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
